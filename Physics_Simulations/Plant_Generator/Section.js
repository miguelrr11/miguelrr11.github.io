...
class Section{
    constructor(pos, angle, ratio, ranges){
        ...
        this.outOfBounds = this.pos.x < 0 || this.pos.x > WIDTH || this.pos.y < 0 || this.pos.y > HEIGHT
    }

    getLastPos(){
        return createVector(
            fastCos(this.angle) * this.long + this.pos.x,
            fastSin(this.angle) * this.long + this.pos.y
        )   
    }
