class Moon extends Nexus{
	...
	createFirstPos(angle, secondOrbit = false){
		this.radius = this.tam/2 + this.orbits.tam/2 + 230
	...
	// Determina si un punto se encuentra en el FOV del orbit (el FOV esta alineado al this.orbits) (ya no se utiliza)
