...
function setup(){
    ...
    selectActiveAttack = createSelect()
    selectActiveAttack.option('Thunder of Rays');
    selectActiveAttack.option('Mega Missile Launcher');
    selectActiveAttack.option('Black Hole X-22');
    selectActiveAttack.option('Force Field Repulsion');
    selectActiveAttack.selected('Thunder of Rays');
